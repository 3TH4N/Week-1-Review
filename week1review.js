...
// Take your first and last name and concat()
  ...
  let firstName = ['Ethan']
  let lastName = ['Alvarado']
  let fullName = firstName.concat(lastName)

// Create a string and make it return true using startsWith()

  let random = ['random']
  console.log(random.startsWith('ran'))

// Now use any variable with endsWith() and return false

  let random1 = ['random']
  console.log(random.endsWith('ran'))

// Finish the following sentence. Use includes() and return true.

const ozgur = 'Once upon a time Ozgur looked up at the Moon, and he saw a big fat cheesecake and ate it'
console.log(ozgur.includes('ate'))
